...
Environment:
  ...
  PI_WEB_AUTH_MODE           local (default) or gateway
  PI_WEB_PASSWORD            Enable local password login and API Basic Auth
  PI_WEB_ALLOWED_HOSTS       Extra exact proxy/custom hostnames, comma-separated
  PI_WEB_GATEWAY_ATTESTATION_SECRET
                             Internal Gateway assertion secret in gateway mode
